...
export const ModalProvider = ({ children }) => {
  ...
  const [isAgregarDireccionModalOpen, setAgregarDireccionModalOpen] = useState(false);  
  ...
  const openAgregarDireccionModal = () => setAgregarDireccionModalOpen(true);
  const closeAgregarDireccionModal = () => setAgregarDireccionModalOpen(false);
  ...
  return (
    <ModalContext.Provider
      value={{
        ...
        openFiltrarModal,
        closeFiltrarModal,
        isAgregarDireccionModalOpen,
        openAgregarDireccionModal,
        closeAgregarDireccionModal
      }}
    >
      {children}
    </ModalContext.Provider>
